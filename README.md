[![Build Status](https://travis-ci.org/mirage-a/jacoco-codecov-gradle-multimodule-example.svg?branch=master)](https://travis-ci.org/mirage-a/jacoco-codecov-gradle-multimodule-example)
